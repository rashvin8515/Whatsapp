...
public class ChatAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                new AlertDialog.Builder(context)
                        .setTitle("Delete")
                        .setMessage("Are u sure u want to delete the message")
        ...
        if(holder.getClass() == SenderViewHolder.class){
            ...
            ((SenderViewHolder)holder).senderTime.setText(String.format("%1$tH:%1$tM:%1$tS.%1$tL", messagesModel.getTimestamp()));

        }else {
            ((ReceiverViewHolder)holder).receiverMsg.setText(messagesModel.getMessage());
            ((ReceiverViewHolder)holder).receiverTime.setText(String.format("%1$tH:%1$tM:%1$tS.%1$tL", messagesModel.getTimestamp()));
